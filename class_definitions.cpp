...
void Shell::run() {
    ...
    void Shell::copyFileContents(ifstream& sourceFile, const string& destination, const vector<string>& args) {
    ...
    void Shell::copyFileContents(const string& source, const string& destination) {
        ifstream sourceFile(source, ios::binary);
        ofstream destFile(destination, ios::binary);
